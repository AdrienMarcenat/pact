...
public class NewSaveState extends State
{
	//======================================[ Attributs ]===========================================//
	...
	public NewSaveState(StateStack mystack, Context context)
	{
	...
	public boolean handleEvent(Event event)
	{
	    if (event.type == Type.KEY_PRESSED)
	    {
		    ...
		    {
		    	SaveManager sam = new SaveManager(0);
		    	mContext.playerInfo = sam.read();
