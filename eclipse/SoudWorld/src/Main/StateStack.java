...
public class StateStack 
{
    ...
    //Recherche la state correspondant à stateID dans mFactories
   ...
   //Applique les changemtents demandés à la Stack stockés dans mPendingList
    ...
    //Structure des ordres pouvant être donnés à la Stack
